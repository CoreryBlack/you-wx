...
function createChunkFileNames(inputDir) {
    return function chunkFileNames(chunk) {
        if (chunk.isDynamicEntry && chunk.facadeModuleId) {
            ...
            // sanitize returned filename: remove leading ../ segments which are invalid as rollup chunkFileNames
            let _name = (0, uni_cli_shared_1.removeExt)((0, uni_cli_shared_1.normalizeMiniProgramFilename)(id, inputDir));
            _name = _name.replace(/^(?:\.\.\/)+/, '');
            return _name + '.js';
        }
        return '[name].js';
